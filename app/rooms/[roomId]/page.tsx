...
export default function RoomPage() {
   ...
   *  不再依赖 hhIndex 的 roomId 过滤，而是：
   *  - 用 hhColumns 找到该 room 的 columnIds
   *  - 用 hhCells 过滤 column_id in columnIds
   *  - label 用 column name + cell code
   */
